                        ...
                        <div className="flex items-center space-x-4">
                            <div className="text-right">
                                <p className="text-sm font-semibold text-slate-800">
                                    Bienvenido, <span className="text-cyan-600">{usuario.nombre}</span>
                                </p>
                                <p className="text-xs text-slate-500 capitalize">{usuario.rol}</p>
                            </div>
                            
                            <div className="w-10 h-10 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-full flex items-center justify-center text-white font-semibold shadow-lg shadow-cyan-500/30">
